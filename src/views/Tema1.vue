...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p(data-aos="fade-right") La proyección de oferta y demanda es una fase importante en el estudio de mercado, que tiene la finalidad de determinar la situación conveniente del mercado al que se quiere ingresar con determinado bien o servicio. 
    p.mt-4(data-aos="fade-right") Este análisis se realiza a través de métodos de proyección de consumo aparente, como el de extrapolación de tendencia, ecuación exponencial y por número de habitantes o clientes. Para estos métodos se debe tener en cuenta las siguientes variables:
    ...
    .col-xl-10.m-auto
      .bloque-texto-g.bloque-texto-g--inverso.color-primario.p-3.p-sm-4.p-md-5
        .bloque-texto-g__img(
          :style="{'background-image': `url(${require('@/assets/curso/tema1/1.svg')})`}" data-aos="fade-right"
        )
    ...
    .col-xl-10.m-auto.mt-5
      .bloque2.bloque-texto-g.bloque-texto-g--inverso.color-primario.p-3.p-sm-4.p-md-5
        .bloque-texto-g__img(
          :style="{'background-image': `url(${require('@/assets/curso/tema1/5.svg')})`}" data-aos="fade-left"
        )
    ...
    p(data-aos="fade-right") Debido a la dinámica propia del mercado, varios de los modelos de pronóstico desarrollados en relación a la predicción de la oferta y la demanda presentan herramientas tecnológicas que facilitan la simulación en los procesos de oferta y demanda.
    p.mt-4(data-aos="fade-right") Entre los simuladores más representativos se tiene:

    .row.mt-5
      .col-lg.mb-4.mb-lg-0.pe-lg-0
        .h-100.p-4.p-md-5(style="background-color:#1A0F91;border-radius:15px 0px 0px 15px;")
          h3.text-white.text-center(data-aos="fade-right") #[em Sales and Operations Planning (S&OP)]
          p.mt-5.text-white(data-aos="fade-right") Integra componentes operacionales del negocio, buscando un enfoque en el consumidor que esté alineado con las estrategias de los gerentes. El propósito de esto es balancear el abastecimiento y la demanda gracias a la comunicación y toma de decisiones.
          p.mt-4.text-white(data-aos="fade-right") El objetivo principal de S&OP, es facilitar el alineamiento organizacional dentro de las empresas entre las metas y los planes de negocio, y a su vez permitir atención rápida a los movimientos del mercado.
      .col-lg.mb-4.mb-lg-0.ps-lg-0
        .h-100.p-4.p-md-5(style="background-color:#FE7062;border-radius:0px 15px 15px 0px;")
          h3.text-white.text-center(data-aos="fade-right") Patrón de diseño modelo, vista, controlador (MVC)
          p.mt-5.text-white(data-aos="fade-right") Este patrón de diseño de #[em.text-white software] tiene como objetivo crear un puente entre el modelo que existe en la mente de las personas y el modelo digital que existe en los datos o computadores de las empresas. El patrón MVC divide el #[em.text-white software] en 3 categorías, 1) el modelo principal del #[em.text-white software], 2) la interacción con el usuario y 3) la presentación de la información dentro del modelo principal.
          p.mt-4.text-white(data-aos="fade-right") MVC como patrón asigna responsabilidades a los individuos y grupo de personas que están inmersas en las categorías mencionadas con anterioridad es por eso que se definen los siguientes roles para estas personas y equipos:
          ul.fa-ul.mt-3
